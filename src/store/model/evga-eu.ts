...
export const EvgaEu: Store = {
  ...
  links: [
    ...
    },
	{
      ...
      model: 'xc gaming',
      series: '3060',
      url: 'https://eu.evga.com/products/product.aspx?pn=08G-P5-3665-KR',
    },
    {
      brand: 'evga',
      model: 'xc gaming',
      series: '3060',
      url: 'https://eu.evga.com/products/product.aspx?pn=12G-P5-3657-KR',
    },
	{
      brand: 'evga',
      model: 'xc gaming',
      series: '3060',
      url: 'https://eu.evga.com/products/product.aspx?pn=08G-P5-3667-KR',
    },
    {
      brand: 'evga',
      model: 'xc gaming',
      series: '3060',
      url: 'https://eu.evga.com/products/product.aspx?pn=08G-P5-3663-KR',
    },
    {
      brand: 'evga',
      model: 'ftw3 ultra',
